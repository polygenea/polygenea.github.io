...
To reach these goals, the model uses a representation of beliefs about the past that somewhat resembles RDF, in that information about a given entity is stored outside of the entity.
